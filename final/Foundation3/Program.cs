...
class Program
{
    static void Main(string[] args)
    {
        ...
        Lecture lecture = new Lecture("Artificial Intelligence", "A lecture on Artificial Intelligence is held in the hall of Wayne Manor for undergraduate students of Gotham City University.", DateTime.Now, lectureAddress, "Bruce Wayne", 40);
